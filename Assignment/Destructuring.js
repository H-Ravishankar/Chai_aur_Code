...
const sentence = "I am xyz. I am learning web development from PW Skills web";
...
// console.log(uniqueElement([1, 2, 3, 6, 8, 9]));
// console.log(uniqueElement([5, 6, 1, 6, 7, 8,]));
...
const person = {
    ...
    age: 21, 
    address: {
        street: "R70 Rest House Road, East",
        city: " Indore ",
